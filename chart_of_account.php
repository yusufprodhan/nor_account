...
?>
			...
			if (!$select->num_rows) {
				...
				$query = $db->query("SELECT * FROM groups where parent_id is null ORDER BY id ");
			?>
				...
				while ($row = $query->fetch_object()) {?>
					<tr>
						...
						<td><?php echo '-';?></td>
						<td><?php echo '-';?></td>
						<td><a class="btn btn-success" href="chart_of_account-sub.php?id=<?php echo $row->id; ?>">View subgroup</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-success" href="chart_of_account-ledgers.php?id=<?php echo $row->id; ?>">View Ledgers</a></td>
					</tr>
					<?PHP
