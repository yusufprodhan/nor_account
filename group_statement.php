...
*/
	...
	<input type="hidden" name="hidvouchertype" >
		<div class="box box-info">
                <div class="box-header with-border">
                  <h1 class="box-title"><span class="fa fa-th">  ACCOUNTS HEADWISE STATEMENT REPORT</span></h1>
                </div>
			
			<?PHP $quer_type=$db->query("SELECT id ,name from groups order by id asc"); ?>
			<p align="left" ><div class="box-header with-border">
...
//$result02=mysql_query($con,$query02);	//print '*'.$vouchertype.'*';		?>
               ...
               <?PHP print "Opening Balance as on ".$showstartdate." is ".$opbalance." ".$optype; ?>
			<div class="table-responsive">
			<table class="table table-bordered chartofaccount" >
				<thead>
					<tr>
						<th>Date</th>
						<th>Voucher</th>
...
<div class="panel-heading"><?PHP print "closing total amount as on ".$showenddate." is ".$groupbal; ?></div>
  <div class="panel-body">
	...
	<input class="btn btn-info" type="submit" name="submit2" value="Report" onclick="centeredPopup('group_statement_report.php?groupid=<?php echo $groupname;?>&startdate=<?php echo $startdate;?>&enddate=<?php echo $enddate;?>&showstartdate=<?php echo $showstartdate;?>&showenddate=<?php echo $showenddate;?>','myWindow','700','700','yes');return false" align="middle">
			<?php
