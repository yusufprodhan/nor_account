                                ...
                                <div class="col-md-12">  
                                    ...
                                    <div class="box box-danger">
                                        <div class="box-header with-border">
                                            <h3 class="box-title"><span class="fa fa-th"> Update Ledger</span></h3>
                                        ...
                                        if (isset($_POST['create'])) {
                                            ...
                                            if (empty($name) && empty($parent_id)) {
                                                ...
                                                $sql = "update ledgers set name='$name', group_id=$parent_id,type=$type,op_balance=$bal,op_balance_dc='$dc',reconciliation=0,notes='$notes' where id=$sledger";

                                                $result = mysqli_query($con, $sql);
                                                echo"<div class=\"alert alert-success alert-dismissible\">
			  <a href=\"#\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">&times;</a>
			  <strong>Success!</strong> One Row successfully updated
			</div>";
                                            }
                                        }
                                        ?>
                                        ...
                                        <div class="box-body"><!-- form body Start-->
                                            ...
                                            <form action="" method="post" name="form1">
                                                <table class="table table-bordered">
                                                    <tr>
                                                        <td><label for="name">Select Ledger:</label></td>
                                                        <td>
                                                            <select name="sledger" id="sledger" class="form-control input-sm" data-placeholder="chart_id" autocomplete="on">
                                                                <option value="0">Select Ledger</option>									<?php $sql = $db->query("select id,name from ledgers"); ?>
...
?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><select name="typeid" id="typeid" class="form-control input-sm"><option value=0>Dr.</option><option value=1>Cr.</option></select></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><textarea name="notes" cols="50" rows="5" id="notes"  class="form-control input-sm"></textarea></td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function () {
                            ...
                            $('#sledger').change(function () {
                                ...
                                $.post("fetch_ledgercontent.php", {country_id: v1},
                                        function (data)
                                        {
                                            var strng = data.split("%");

                                            document.form1.name.value = strng[0];
                                            document.form1.parent_id.value = strng[1];
                                            document.form1.typeid.value = strng[2];
                                            document.form1.txtbal.value = strng[3];
                                            document.form1.notes.value = strng[6];
