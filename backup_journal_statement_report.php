...
$select = "select m.*,t.name as tname from  entries e,entryitems m, entrytypes t where e.entrytype_id=t.id and e.id=m.entry_id  and t.id='$journaltype' and e.date between '$startdate' and '$enddate'";
//print $select;
...
//$result02=mysql_query($con,$query02);	//print '*'.$vouchertype.'*';		?><br><br>
                         ...
                         <h1>JOURNAL HEAD : <?php echo $rowledger->ledgername;?> </h1>
                
    <div class="panel panel-info">
    <div class="panel-heading"><?PHP print "Opening Balance as on ".$showstartdate." is ".$opbalance." ".$optype; ?></div>
...
<div class="panel-heading"><?PHP print "closing balance Balance as on ".$showenddate." is ".$cumbalance." ".$cumtype; ?></div>
  <div class="panel-body">
    
  </div>
</div>
	<input class="btn btn-info" type="submit" name="submit2" value="Report" onclick="">
			<?php
