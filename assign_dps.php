                    ...
                    <div class="content-wrapper">
                        ...
                        <section class="content">
                            ...
                            if (isset($_POST['create'])) {
                                ...
                                //$bio 		= trim($_POST['bio']);
                                //$dt=date('Y-m-d');
                                $sql = "update member_info set dps=$dname where             acc_no='$member'";
                                    ...
                                    <form action="" method="post">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td><select name="dpsgrp" id="dpsgrp" class="form-control" data-placeholder="chart_id">
...
<?php while ($row = $sql->fetch_object()) {
    ?>
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><button type="submit" class="btn btn-success" name="create">ASSIGN DPS</button>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-info" href="home.php">BACK </a></td>
                                            </tr>
                                        </table>
                                    </form>
                                </div>
