        ...
        <section class="content">
          ...
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title"><span class="fa fa-th"> Read Group Details</h3>
...
if(isset($_GET)){
	...
	$read = $db->prepare("SELECT name,parent_id FROM groups WHERE id = ?");
	$read->bind_param('i', $id);
	$read->execute();
	$read->bind_result($name, $parent_id);
...
?>
		...
		<div class="box box-info">
	        ...
	        <table class="table">
              ...
              <tr>
                <td colspan="2" align="center"><a class="btn btn btn-primary" href="chart_of_account.php">BACK</a> </td>
              </tr>
            </table>
           </div>
