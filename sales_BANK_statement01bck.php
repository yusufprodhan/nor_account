  ...
  <br>
          ...
          <div class="table-responsive">
			<table class="table table-striped" >
				<thead>
					<tr>
                    	<th>Bank Name : <?php echo $bankn;?></th>
						<th>Branch Name : <?php echo $branchn;?></th>
						<th>Account Name :<?php echo $accountname;?></th>
                        <th>Account No :<?php echo $accountno;?></th>
                        </tr>
				</thead>
             </table>
             </div>
...
<div class="panel-heading"><?PHP print "closing balance Balance as on ".$showenddate." is ".$txtcumbalance; ?></div>
	...
	<input class="btn btn-info" type="submit" name="submit2" value="Report" onclick="" align="middle">
			<?php
