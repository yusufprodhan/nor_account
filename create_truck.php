...
if(isset($_POST['create'])){
	...
	$sql="insert into truck_info(id,truck_no,mem_id,truck_type,include_date)values('','$truck_no','$member','$truck_type','$tdate')";
 ...
 <!-- Default box -->
		<div class="box box-primary">
                <div class="box-header with-border">
                  <h1 class="box-title"><span class="fa fa-th"> Create Truck</span></h1>
                </div>
		<div class="box-body">
			<form action="" method="post">
                ...
                <?php } ?>
                    ...
                    <tr>
						...
						<td><input type="text" id="truck_no" name="truck_no" class="form-control input-sm"></td>
					</tr>
                    <tr>
						<td><label for="name">Truck Type:</label></td>
						<td><input type="text" id="truck_type" name="truck_type" class="form-control input-sm"></td>
					</tr>
                    <tr>
						<td><label for="name">Inclusion Date::</label></td>
						<td><input type="date" id="tdate" name="tdate" class="form-control input-sm"></td>
					</tr>
					...
					<tr>
						<td></td>
						<td><button type="submit" class="btn btn-success" name="create">ASSIGN TRUCK</button>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-info" href="home.php">BACK </a></td>
					</tr>
				</table>
			</form>
           </div>
