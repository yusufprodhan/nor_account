        ...
        <section class="content">
          ...
          <div class="box box-danger">
            <div class="box-header with-border">
             <h1 class="box-title"><span class="fa fa-th">  Member Monthly Fee Report.</span></h1>
...
$select="select m.memname,DATE(e.date),i.amount from ledgers l, entries e, entryitems i,member_info m,bonus_dps bd where e.date between '$startdate' and '$enddate' and l.id=i.ledger_id and i.entry_id=e.id and i.entrytype_id=e.entrytype_id and i.id=bd.entryitems_id and l.name=m.acc_no and bd.trantype=3 order by e.date,m.acc_no";
