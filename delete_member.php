...
if(isset($_POST['create'])){
	...
	//print $sql;
	$sql="update member_info set    mem_no='$memberno',group_no='$groupname',join_date='$jdate',prbal=$pbalance,status=$memstatus,memname='$mname',fname='$fname',moname='$tname',spname='$sname',chname='$cname',nid='$nid',maddr='$maddress',paddr='$paddress',dps=$dpsgrp,userid='$userid',usertype=$usertype,userpass='$txtconfpass' where   acc_no='$accountno'";
			//$result=mysqli_query($con,$sql);
			
		 //print $sql;
		 $sql="delete from member_info where acc_no='$accountno'";
		$result=mysqli_query($con,$sql);
		$sql="delete from ledgers where name='$accountno'";
		$result=mysqli_query($con,$sql);
		...
		<div class="box-body">
			<form action="" method="post">
                ...
                <?php } ?>
					...
					<tr>
						<td></td>
						<td><button type="submit" class="btn btn-success" name="create">DELETE MEMBER</button>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-info" href="home.php">BACK </a></td>
					</tr>
				</table>
			</form>
           </div>
