    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title"><span class="fa fa-th">  ACOUNTS</h3>
		...
		<div class="box box-info">
                <div class="box-header with-border">
                  <h1 class="box-title"><span class="fa fa-th">  Cheque Search</span></h1>
                </div>
			
			
			<form action="cheque_dishonor.php" method="post">
				<table class="table table-bordered">
					<tr>
						<td><label for="name">Cheque No:</label></td>
						<td><input type="text" id="txtchq" name="txtchq" class="form-control input-sm"></td>
					</tr>
                    
					
					<tr>
						<td></td>
						<td><button type="submit" class="btn btn-success" name="create">SEARCH</button>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-info" href="home.php">BACK </a></td>
					</tr>
				</table>
			</form>
</div>
