        ...
        <section class="content">
          ...
          <div class="box box-danger">
            <div class="box-header with-border">
             <h1 class="box-title"><span class="fa fa-th">  Cash    Statement Report.</span></h1>
...
$sql="select id,op_balance,op_balance_dc from ledgers where (name like '%Hand%' or name like '%hand%')";
$result=mysqli_query($con,$sql);
$row=mysqli_fetch_array($result);
$lid=$row['id'];
$opsign=$row['op_balance_dc'];
$opbalamt=$row['op_balance'];
