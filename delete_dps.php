...
if(isset($_POST['create'])){
	...
	//$bio 		= trim($_POST['bio']);
		...
		//$dt=date('Y-m-d');
	$sql="delete from dps_info where id=$dpsgrp";
       ...
       <strong>Attention!</strong> Successfully Deleted.
       </div>
<?PHP } ?>       
?>
 <!-- Default box -->
		<div class="box box-primary">
                <div class="box-header with-border">
                  <h1 class="box-title"><span class="fa fa-th"> Delete DPS</span></h1>
                </div>
		<div class="box-body">
			<form action="" method="post">
                ...
                <?php } ?>
					...
					<tr>
						<td></td>
						<td><button type="submit" class="btn btn-success" name="create">DELETE DPS</button>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-info" href="home.php">BACK </a></td>
					</tr>
				</table>
			</form>
           </div>
