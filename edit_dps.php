...
if(isset($_POST['create'])){
	...
	//$bio 		= trim($_POST['bio']);
		...
		//$dt=date('Y-m-d');
	$sql="update dps_info set    dps_name='$dname',dps_amount=$damount where id=$dpsgrp";
       ...
       <strong>Attention!</strong> Successfully Updated.
       </div>
<?PHP } ?>       
?>
 <!-- Default box -->
		<div class="box box-primary">
                <div class="box-header with-border">
                  <h1 class="box-title"><span class="fa fa-th"> Edit DPS</span></h1>
                </div>
		<div class="box-body">
			<form action="" method="post">
                ...
                <?php } ?>
                    ...
                    <tr>
						<td><label for="name">New DPS Name:</label></td>
						<td><input type="text" id="dname" name="dname" class="form-control input-sm"></td>
					</tr>
                    <tr>
						<td><label for="name">DPS Amount:</label></td>
						<td><input type="text" id="damount" name="damount" class="form-control input-sm"></td>
					</tr>
					...
					<tr>
						<td></td>
						<td><button type="submit" class="btn btn-success" name="create">UPDATE DPS</button>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-info" href="home.php">BACK </a></td>
					</tr>
				</table>
			</form>
           </div>
