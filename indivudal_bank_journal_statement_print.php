        ...
        <div class="row">
          <div class="col-xs-12">
            <h2 class="page-header">
              <i class="fa fa-globe"><img src="customimage/Hili Trucklogo.png" alt="..." class="img-rounded" width="42" height="42"></i> Hili Truck Mailk Group
...
$bankacc=ltrim(rtrim($rowledger->ledgername));
$banksql="select * from bankinfo where trim(accountno)='$bankacc'";
$resultbank=mysqli_query($con,$banksql);
$rowbank = $resultbank->fetch_object();
$bankname=ltrim(rtrim($rowbank->bankname));
$branchname=ltrim(rtrim($rowbank->branchname));
$accountname=ltrim(rtrim($rowbank->accountname));
?>
			   <div class="row">
               <div class="col-sm-12">
               <h4><strong>Bank Wise Journal Statement</strong></h4>
               <h5><strong>Bank:<?PHP print $bankname.',Branch:'.$branchname.',A/C Name:'.$accountname;?></strong></h5>
                A/C Number: <?php echo ' '.$rowledger->ledgername;?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                Reporting  Date From: <?PHP print '      '.$startdate.'    To:  '.$enddate; ?>
                 </div>
                 </div>
           ...
           <div class="row">
			...
			<table width="100%" class="table table-bordered" >
                ...
                <td></td>
                <td></td>
                <td><strong><?PHP if($optype=='D'){print 'TK '.number_format($opbalance, 2, '.', ',');}; ?></strong><strong><?PHP if($optype=='C'){print 'TK '.number_format($opbalance, 2, '.', ',');}; ?></strong></td>
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td><strong><?PHP if($cumtype=='D'){print 'TK '.number_format($cumbalance, 2, '.', ',');}; ?></strong><strong><?PHP if($cumtype=='C'){print 'TK '.number_format($cumbalance, 2, '.', ',');}; ?></strong></td>
                </tr>
			</tbody>
			</table>
			</div>
