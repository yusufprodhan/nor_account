        ...
        <section class="content">
          ...
          <div class="box box-danger">
            <div class="box-header with-border">
             <h1 class="box-title"><span class="fa fa-th">  Truck  (NonMemberwise) Report.</span></h1>
...
<p align="center"> <h3><strong><?PHP print'Date From: '.$startdate.'  To:  '.$enddate; ?></strong></h3></p>
			...
			<table class="table table-bordered" >
				...
				$sl=1;
						...
						$sql="select  e.date,t.truck_no,t.truck_type,i.refund    from entryitems i inner join entries e on e.id=i.entry_id and e.entrytype_id=i.entrytype_id inner join truck_info t on i.truck_id=t.id  where  t.mem_type=2 and   e.date  between '$startdate' and '$enddate' and i.truck_id>0  and i.dc='C'";
					...
					?>				<tr>
						...
						<td><?php echo 'Non Member';?></td>
						
						
						<td ><?php $amt=100;print $amt;?></td><td><?PHP if($row[3]==0){print 'Yes';} ?></td><td><?PHP if($row[3]==1){print 'Yes';} ?></td></tr>
