...
document.form1.submit();
	...
	<form  name="form1" method="post" action="dtstatjournal.php">
	...
	<input type="hidden" name="hidvouchertype" >
			...
			<div class="form-group">
			  ...
			  <?PHP $quer_type=$db->query("SELECT id ,name from entrytypes order by id asc"); ?>
			    ...
			    <option value=0>Select Type of Journal</option>
              ...
              <div class="col-sm-12">
			  <INPUT type="date" name="txtstartdate" id="txtstartdate" value="" class="form-control select2-container"/>
              </div>
              <div class="col-sm-12">
              <INPUT type="date" name="txtenddate" id="txtenddate" value="" class="form-control select2-container"/>
              </div>
              <div class="col-sm-12">
              </div>
              <div class="col-sm-12">
              <input class="btn btn-info pull-right" type="submit" name="submit1" value="submit">
              </div>
		</form>
