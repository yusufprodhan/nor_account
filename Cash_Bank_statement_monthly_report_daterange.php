        ...
        <section class="content">
          ...
          <div class="box box-danger">
            <div class="box-header with-border">
             <h1 class="box-title"><span class="fa fa-th">  Cash And Bank  Statement Report.</span></h1>
...
$sql="select id,op_balance,op_balance_dc,name from ledgers where ((name like '%Hand%' or name like '%hand%') or (group_id=63))";
