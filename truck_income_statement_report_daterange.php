...
<div><b>From:</b> <?PHP print $startdate; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>To:</b> <?PHP print $enddate;?></div>
            ...
            <div>
	<input class="btn btn-info" type="submit" name="submit2" value="Report" onClick="centeredPopup('truck_income_statement_report_print.php?startdate=<?php echo $startdate;?>&enddate=<?php echo $enddate;?>','myWindow','700','700','yes');return false" align="middle">
</div>
			<?php
