...
//$result02=mysql_query($con,$query02);	//print '*'.$vouchertype.'*';		?>
			...
			$sql="select sum(amount) from entryitems e inner join ledgers l on e.ledger_id=l.id inner join entries t on t.id=e.entry_id  where l.name like '%Electric%' and t.date between '$startdate' and '$enddate'";
			$resultE=mysqli_query($con,$sql);
			$rowE = mysqli_fetch_row($resultE);
			$totelec=$rowE[0];
			$sql="select sum(amount) from entryitems e inner join ledgers l on e.ledger_id=l.id inner join entries t on t.id=e.entry_id inner join groups g on (l.group_id=g.id or l.group_id=g.parent_id ) where  t.date between '$startdate' and '$enddate' and (g.id=3 or g.parent_id=3)";
			$resultO=mysqli_query($con,$sql);
			$rowO = mysqli_fetch_row($resultO);
			$tototherincome=$rowO[0];
			$sql="select sum(amount) from entryitems e inner join ledgers l on e.ledger_id=l.id inner join entries t on t.id=e.entry_id  where l.name like '%Gate%' and t.date between '$startdate' and '$enddate'";
			$resultE=mysqli_query($con,$sql);
			$rowE = mysqli_fetch_row($resultE);
			$totgate=$rowE[0];
			$sql="select sum(amount) from entryitems e inner join ledgers l on e.ledger_id=l.id inner join entries t on t.id=e.entry_id  where l.name like '%Breakfast%' and t.date between '$startdate' and '$enddate'";
			$resultE=mysqli_query($con,$sql);
			$rowE = mysqli_fetch_row($resultE);
			$totbreakfast=$rowE[0];
			$sql="select sum(amount) from entryitems e inner join ledgers l on e.ledger_id=l.id inner join entries t on t.id=e.entry_id  where l.name like '%Paper%' and t.date between '$startdate' and '$enddate'";
			$resultE=mysqli_query($con,$sql);
			$rowE = mysqli_fetch_row($resultE);
			$totpaper=$rowE[0];
			?>
            <tr>
						...
						<td><?php echo 'Gate Cost';?></td>
						
						<td><?php echo '';?></td>
						
						
						<td ><?php echo $totgate;?></td>
                        </tr>
                   <tr>
                        ...
                        <td><?php echo 'Office Breakfast';?></td>
						
						<td><?php echo '';?></td>
						
						
						<td ><?php echo $totbreakfast;?></td>
				  </tr>
			<tr>
						
                        
                        <td><?php echo $enddate;?></td>
						<td><?php echo 'Electric Line Rent';?></td>
						
						<td><?php echo '';?></td>
						
						
						<td ><?php echo $totelec;?></td>
                        <td><?php echo 'Paper Bill';?></td>
						
						<td><?php echo '';?></td>
						
						
						<td ><?php echo $totpaper;?></td>
				  </tr>
