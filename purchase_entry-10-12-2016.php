...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="box-body">
			...
			if((isset($_GET['hid']))||(isset($_GET['type'])))
			{
			    ...
			    echo"<script>document.form1.hid.value='$type';</script>";?> 
                  ...
                  <h3 class="box-title"><span class="fa fa-th"> Purchase</span>&nbsp;Form</h3>
                </div>
				<?PHP
                }
	...
	if (isset($_POST['credit_add'])){	      if($_POST['credit_add']=='Add Credit'){
              ...
              <div class="box-body"><!-- voycher box body star-->
			       <!--form setup-->
                 <form class="form-horizontal" name="form1" method="post" action ="addsavepurchase.php">
              ...
              <div class="box-header with-border"><h3 class="box-title">Purchase Item</h3></div><!-- /.box-header -->
              <div class="box-body">
              <div class="form-group" >
  ...
  <label><input type="checkbox" value="12" id="chkitem" name="chkitem">Add New</label>
            ...
            <div class="form-group">
            <div class="col-md-2"><label class="control-label" for="debit_amount">Item Buy Price</label></div>
			<div class="col-md-10">
            ...
            <div class="col-sm-offset-4 col-sm-10">
             <input type="submit" name="debit_add" id="debit_add" class="btn btn-success" value="Add Purchase" />
            </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="box box-success box-solid">
              <div class="box-header with-border"><h3 class="box-title">Supplier Information</h3></div><!-- /.box-header -->
              <div class="box-body">
              
               <div class="col-md-2"><label for="inputEmail3" >Supplier</label></div>
              <div class="col-md-10">
  ...
  <label><input type="checkbox" value="12" id="chksupplier" name="chksupplier">Add New</label>
			...
			<input type="text" name="sup_email" id="sup_email" placeholder="00.00" class="form-control" value="" />
              ...
              <div class="form-group">
            <div class="col-sm-offset-4 col-sm-10">
             <input type="submit" name="supplier_add" id="supplier_add" class="btn btn-success" value="Add Supplier" />
            </div>
            </div>
											...
											<tbody>
												...
												//foreach ($details as $list) {
													//if ($list['debit']) {
														...
														$sql=$db->query("select m.id,l.id as lid,l.name,m.amount,m.itemnarat from ledgers l, entryitems m where m.ledger_id=l.id and m.entry_id=$entr_id and m.dc='D' ");


														while ($row = $sql->fetch_object()) {
															
$lid=$row->lid;
$sql2 = "SELECT s.buy_price,s.quantity FROM stocktbl s WHERE s.ledger_id = ".$lid." order by s.stock_date asc";
$query2 = mysqli_query($con, $sql2);

while($row2=mysqli_fetch_array($query2))
{
$bprice=$row2['buy_price'];
$quantity=$row2['quantity'];
														...
														<tr>
															...
															<td class="center">
																<input type="hidden" value="<?php //echo $list['id']; ?>" /><a href="purchase_entry.php?did=<?php echo $row->id;?>&type=<?php echo $type;?>"><span class="btn btn-danger debit_voucher_delete"><i class="icon-trash icon-white"></i>Delete</span></a>
															</td>
														</tr>
														<?php
...
<select name="bankname" id="drop1" class="form-control select2-container  col-sm-10">
	...
	<?php } ?>
       ...
       <div class="form-group">
         ...
         <div id="accountno" name="accountno" class="col-sm-10"></div>
         </div>
              ...
              <div class="box-body">
                 ...
                 <div class="col-sm-offset-2 col-md-5">
                  ...
                  <input type="submit" name="complete" class="btn btn-lg btn-block btn-success" id="journal_complete" value="Complete Purchase Entry" />
                 </div>
                 </div>
                 <div class="form-group"> 
                 <div class="col-md-5">
...
$.post("fetch_buyprice.php", {country_id : v1 },
function(data)
{
...
$.post("fetch_supplier.php", {ledger_id : v1 },
function(data)
{
	var strng=data.split("%");
