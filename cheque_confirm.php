        ...
        <section class="content">
          ...
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title"><span class="fa fa-th"> Confirm Cheque Dishonour</h3>
...
$previllage=$_SESSION['userid'];
	...
	//$txtnewpass 	= trim($_POST['txtnewpass']);
	//$txtconfpass 		= trim($_POST['txtconfpass']);
	//$bal 		= trim($_POST['txtbal']);
	//$notes 		= trim($_POST['notes']);
	//$bio 		= trim($_POST['bio']);

	$sql="insert into dishonor_entries select * from entries e where e.id='$entry_id'";
	$result=mysqli_query($con,$sql);
	
	$sql="insert into dishonor_entryitems select * from entryitems e where e.entry_id='$entry_id'";
			//$result=mysqli_query($con,$sql);
...
<div class="panel-heading">Cheque successfully dishonoured</div>
