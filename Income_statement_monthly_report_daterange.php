...
//$result02=mysql_query($con,$query02);	//print '*'.$vouchertype.'*';		?>
			...
			<table class="table table-bordered" >
				...
				$totnonmemamount=0.0;
					...
					$totamount=0.0;
						...
						$totmemamount+=$memamount;
						$totnonmemamount+=$nonmemamount;
            ...
            <tr>
				  ...
				  ></tr>
                   <tr>
						...
						<td><?php echo $totnonmemamount;?></td>
			...
			while($rowincomeroot = mysqli_fetch_row($resultincomeroot)){
							...
							$sqlincomechildlevel2="select id,name from ledgers where group_id=$incomechildlevel2 and name not like '%truck%'";
							...
							$sqllevel2amt="select sum(amount) from entryitems m,entries e  where e.date between '$startdate' and '$enddate' and e.id=m.entry_id and e.entrytype_id=m.entrytype_id and m.ledger_id=$incomechildlevel2ledg and m.dc='C'";
							//print $sqllevel2amt;
					$resultlevel2amt=mysqli_query($con,$sqllevel2amt);	$rowlevel2amt = mysqli_fetch_row($resultlevel2amt);
					$clevel2amt=$rowlevel2amt[0];
					$sqllevel2amt="select sum(amount) from entryitems m,entries e  where e.date between '$startdate' and '$enddate' and e.id=m.entry_id and e.entrytype_id=m.entrytype_id and m.ledger_id=$incomechildlevel2ledg and m.dc='D'";
					$resultlevel2amt=mysqli_query($con,$sqllevel2amt);	$rowlevel2amt = mysqli_fetch_row($resultlevel2amt);
...
<tr>
				...
				$sqlincomechildlevel1="select id,name from ledgers where group_id=$incomechildlevel1 and name not like '%truck%'";
						//print $sqlincomechildlevel1;
						$resultincomechildlevel1=mysqli_query($con,$sqlincomechildlevel1);
							while($rowincomechildlevel1 = mysqli_fetch_row($resultincomechildlevel1)){
							$incomechildlevel1ledg=$rowincomechildlevel1[0];$lname=$rowincomechildlevel1[1];
							$sqllevel1amt="select sum(amount) from entryitems m,entries e  where e.date between '$startdate' and '$enddate' and e.id=m.entry_id and e.entrytype_id=m.entrytype_id and m.ledger_id=$incomechildlevel1ledg and m.dc='C'";
					$resultlevel1amt=mysqli_query($con,$sqllevel1amt);	$rowlevel1amt = mysqli_fetch_row($resultlevel1amt);
					$clevel1amt=$rowlevel1amt[0];
					$sqllevel1amt="select sum(amount) from entryitems m,entries e  where e.date between '$startdate' and '$enddate' and e.id=m.entry_id and e.entrytype_id=m.entrytype_id and m.ledger_id=$incomechildlevel1ledg and m.dc='D'";
					$resultlevel1amt=mysqli_query($con,$sqllevel1amt);	$rowlevel1amt = mysqli_fetch_row($resultlevel1amt);
			...
			$sqlprnt="select id,name from ledgers where group_id=3 and name not like '%truck%'"; $resultprnt=mysqli_query($con,$sqlprnt);
			while($rowprnt = mysqli_fetch_row($resultprnt)){
							$lidprnt=$rowprnt[0];$lname=$rowprnt[1];
							$sqllevel2amt="select sum(amount) from entryitems m,entries e  where e.date between '$startdate' and '$enddate' and e.id=m.entry_id and e.entrytype_id=m.entrytype_id and m.ledger_id=$lidprnt and m.dc='C'";
					$resultlevel2amt=mysqli_query($con,$sqllevel2amt);	$rowlevel2amt = mysqli_fetch_row($resultlevel2amt);
					$clevel2amt=$rowlevel2amt[0];
					$sqllevel2amt="select sum(amount) from entryitems m,entries e  where e.date between '$startdate' and '$enddate' and e.id=m.entry_id and e.entrytype_id=m.entrytype_id and m.ledger_id=$lidprnt and m.dc='D'";
					$resultlevel2amt=mysqli_query($con,$sqllevel2amt);	$rowlevel2amt = mysqli_fetch_row($resultlevel2amt);
					$dlevel2amt=$rowlevel2amt[0];
					$ballevel2=$clevel2amt-$dlevel2amt;
?>
