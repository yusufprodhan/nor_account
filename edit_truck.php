...
if(isset($_POST['create'])){
	...
	$sql="update truck_info set  truck_no='$truck_no',mem_id='$member',truck_type='$truck_type',include_date='$tdate'  where id=$memselect";
 ...
 <!-- Default box -->
		<div class="box box-primary">
                <div class="box-header with-border">
                  <h1 class="box-title"><span class="fa fa-th"> Update Truck</span></h1>
                </div>
		<div class="box-body">
			<form action="" method="post">
                ...
                <?php }else{ ?> <option value="<?php echo $row->acc_no;?>" ><?php echo $row->memname;?></option><?PHP } } ?>
					...
					<tr>
						<td></td>
						<td><button type="submit" class="btn btn-success" name="create">UPDATE TRUCK</button>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-info" href="home.php">BACK </a></td>
					</tr>
				</table>
			</form>
           </div>
